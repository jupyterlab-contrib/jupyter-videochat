...
```
https://mybinder.org/v2/gh/yuvipanda/jupyter-videochat/demo?urlpath=tree%3Fjvc%3DStand-Up
                                                         # URL-encoded  [? ] [=  ]
```
...
```http
https://mybinder.org/v2/gh/yuvipanda/jupyter-videochat/demo?
urlpath=git-pull
...
[binder]:
  https://mybinder.org/v2/gh/yuvipanda/jupyter-videochat/demo?urlpath=lab
[binder-reqs]:
