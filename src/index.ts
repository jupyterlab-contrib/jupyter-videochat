...
async function activate(app: JupyterFrontEnd, palette: ICommandPalette, restorer: ILayoutRestorer) {
  console.log('JupyterLab extension jupyter-jitsi is activated!');
  // Create a blank content widget inside of a MainAreaWidget
  let widget: MainAreaWidget<JitsiWidget>;

  const command: string = 'jitsi:open';


  let tracker = new WidgetTracker<MainAreaWidget<JitsiWidget>>({
    namespace: 'jitsi'
  });
